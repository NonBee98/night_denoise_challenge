...
class Shufflenet(nn.Module):
    ...
    def __init__(self, inp, oup, base_mid_channels, *, ksize, stride,
        ...
        if activation == 'ReLU':
            ...
            branch_main[2] = nn.Hardsigmoid()
            branch_main[-1] = nn.Hardsigmoid()
            if useSE:
...
class Shuffle_Xception(nn.Module):
    ...
    def __init__(self, inp, oup, base_mid_channels, *, stride, activation,
        ...
        if activation == 'ReLU':
            ...
            branch_main[4] = nn.Hardsigmoid()
            branch_main[9] = nn.Hardsigmoid()
            branch_main[14] = nn.Hardsigmoid()
